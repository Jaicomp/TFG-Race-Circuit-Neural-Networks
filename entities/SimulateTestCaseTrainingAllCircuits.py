...
class Scene:
    ...
    def __init__(self, num_cars, circuits, circuits_in_binary, has_to_save_car, num_max_simulations, ponderation):
        self._test_case = self.get_test_case_from_circuits(circuits_in_binary)
        self._network_best_car = pickle.load(open('../TestCasesNetsTrainingAllCircuits/testcase' + str(self._test_case) + '.csv', 'rb'))
...
def main(num_cars, circuits, circuits_in_binary, has_to_save_car, num_max_simulations, ponderation):
    ...
    scene = Scene(num_cars, circuits, circuits_in_binary, has_to_save_car, num_max_simulations, ponderation)
